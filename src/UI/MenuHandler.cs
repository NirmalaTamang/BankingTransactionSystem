...
public class MenuHandler
{
    ...
    public MenuHandler(IAuthService authService, ITransactionService transactionService, IAdminService adminService)
    {
    ...
    private void ShowCustomerMenu(Account account)
    {
        while (true)
        {
            ...
            if (choice == "1")
            {
                ...
                decimal balance = _transactionService.Withdraw(account.AccountNumber, amount);
            ...
            else if (choice == "2")
            {
                ...
                decimal newBalance = _transactionService.Deposit(account.AccountNumber, amount);
